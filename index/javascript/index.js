document.addEventListener('DOMContentLoaded', function () {
    var audio = new Audio('index/sound/Menubgm.mp3');
    ...
    button2.addEventListener('click', function () {
      window.location.href = 'q2/q2.html';
    });
    ...
    playButton.addEventListener('click', function () {
      if (isPlaying) {
        audio.play();
        playButton.src = 'index/image/playbutton.png';
      } else {
        audio.pause();
        playButton.src = 'index/image/mutebutton.png';
      }
      isPlaying = !isPlaying;
    });
  });
